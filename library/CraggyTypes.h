...
#define CRAGGY_ROUGH_TIME_SIGNATURE_LENGTH 64
#define CRAGGY_ROUGH_TIME_HASH_LENGTH 32

typedef uint8_t craggy_rough_time_payload_t[CRAGGY_ROUGH_TIME_MIN_REQUEST_SIZE];
...
struct craggy_roughtime_result {
    craggy_rough_time_t time;
    craggy_rough_time_radius_t radius;
};

typedef struct craggy_roughtime_result craggy_roughtime_result;
