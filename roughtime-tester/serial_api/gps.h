...
struct rawdata_t {
    ...
    struct meas_t {
        ...
        double dopplerMS;       /* meter/second */
        int    wholeChips;
        int    fracChips;
        int    intCodePhase;      /* integer part of the codePhase */
...
#define GPSTIME_SET     (1llu<<46)
#define MEASX_SET       (1llu<<47)
#define REPORT_SET      (1llu<<48)

#define SET_HIGH_BIT    49
...
#define UNION_SET       (AIS_SET|ERROR_SET|GST_SET| \
                         LOGMESSAGE_SET|OSCILLATOR_SET|PPS_SET| \
                         RTCM2_SET|RTCM3_SET|TOFF_SET|VERSION_SET)
...
void gpsd_zero_satellites(struct gps_data_t *sp);
void gpsd_zero_raw(struct gps_data_t *sp);
